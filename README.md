...
<p align="center">
  <img src="https://img.shields.io/badge/Version-2.7-saffron?style=flat-square&color=FF9933" />
...
## VidyaKosha — Semantic Search (v2.0+, improved v2.7)
...
v2.7: retrieval now weights by `relevance × importance × recency`. High-importance memories surface first.
...
| **v2.7** | Incremental VidyaKosha sync, importance-weighted retrieval, `yantra stats`, admission refinement |
...
```
openyantra/
├── openyantra.py             ← Core library v2.7
