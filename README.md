...
| **v2.9** | Session log archival, integrity check, partial ODS reads, Stats tab, 6 UI screenshots |
| **v2.9.1** | Copy Context button — paste full memory into Claude.ai, ChatGPT, or any AI chat | | Agrasandhanī integrity check, session log archival, partial ODS reads, Stats dashboard tab |
