"""
yantra_ui.py — OpenYantra Browser Dashboard v2.5
...
app = FastAPI(title="OpenYantra", version="2.5", docs_url=None, redoc_url=None)
_oy = None
...
<header>
  <div>
    ...
    <small>Sacred Memory Machine · v2.5 · Chitragupta-secured</small>
  </div>
...
async function loadToday(){
  ...
  document.getElementById('today').innerHTML='<div class="cards">'+cards+'</div>'+body;
}
...
def main():
    parser = argparse.ArgumentParser(description="OpenYantra Dashboard v2.5")
