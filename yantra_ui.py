"""
yantra_ui.py — OpenYantra Browser Dashboard v2.6
...
app = FastAPI(title="OpenYantra", version="2.6", docs_url=None, redoc_url=None)
_oy = None
...
<header>
  <div>
    ...
    <small>Sacred Memory Machine · v2.6 · Chitragupta-secured</small>
  </div>
...
def main():
    parser = argparse.ArgumentParser(description="OpenYantra Dashboard v2.6")
