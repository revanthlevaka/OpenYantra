...
name: openyantra
description: >
  Implements OpenYantra v2.5 — The Sacred Memory Machine — persistent,
...
# OpenYantra v2.5 — The Sacred Memory Machine
...
oy.bootstrap(user_name="Revanth Levaka", occupation="Filmmaker", location="Hyderabad, IN")
