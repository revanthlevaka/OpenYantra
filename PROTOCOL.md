# OpenYantra Protocol Specification — v2.4
...
| v2.4 | Packaging — complete repo, PROTOCOL.md, SKILL.md, DEPLOYMENT.md restored |
...
### System Prompt Block (v2.4)

```
[OPENYANTRA CONTEXT — v2.4 | Chitragupta-secured]
...
## 15. Agent Implementation Checklist v2.4
